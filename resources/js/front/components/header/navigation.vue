        ...
        >
            ...
            >
                ...
                <div
                    ...
                    @mouseenter="depClass = 'show'"
                    @mouseleave="depClass = ''"
                >
                    <span class="nav-link cursor-pointer">{{
                        t("Departments")
                    }}</span>
                    <div :class="['dropdown-panel', depClass]">
                        <departments />
                    </div>
                </div>
            ...
            >
                ...
                <div>
                    <span
                        ...
                        @click="depClass = depClass === 'show' ? '' : 'show'"
                    >
                        {{ t("Departments") }}
                    </span>
                    <div
                        :class="[
                            'dropdown-panel bg-white text-black',
                            depClass,
                        ]"
                    >
                        <departments />
                ...
                <div class="relative mt-2">
                    ...
                    <div
                        v-show="dropdownOpen"
                        class="dropdown-panel w-full text-black bg-white"
                    >
                        <ul>
                            <li>
                                <a
