        ...
        >
            ...
            >
                <div
                    ...
                    :class="{
                        hidden: !isSlideActive(index),
                        'opacity-0': !isSlideActive(index),
                        'opacity-100': isSlideActive(index),
                    }"
            ...
            <div
                class="absolute bottom-0 left-0 right-0 z-10 mx-[15%] mb-4 flex list-none justify-center p-0"
            ...
            >
                <span>
                    <i class="material-icons text-darkblue font-xl"
