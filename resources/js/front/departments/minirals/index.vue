        ...
        <div v-if="departmenthead.position === 'miniral director'">
            <div class="w-screen h-64 bg-darkblue">
                <div class="text-center">
                    <h1
                        class="text-4xl font-bold p-16 font-roboto rounded-lg text-white"
                    >
                        Mining Opration Licensing & Management Group
                    </h1>
                    <div
                    ...
                    >
                        <div class="border-2 rounded-2xl w-8 h-8">
                            <div
                                class="border-2 mx-auto rounded-xl bg-white w-5 h-5"
                            ></div>
                        </div>
                        <div class="border-2 rounded-2xl w-8 h-8">
                            <div
                                class="border-2 mx-auto rounded-xl bg-blue-500 w-5 h-5"
                            ></div>
                        </div>
                        <div class="border-2 rounded-2xl w-8 h-8">
                            <div
            ...
            <div class="grid md:grid-cols-3 sm:m-16 gap-8">
                ...
                <div class="md:col-span-2">
                    <div class="lg:flex lg:flex-row gap-8 m-8">
                        ...
                        />
                        <div>
                            <h1 class="font-bold text-2xl text-sky-500">
                                Vision
                            </h1>
                            <p class="font-roboto text-md pt-4">
                    ...
                    <div class="lg:flex lg:flex-row gap-8 m-8">
                        ...
                        />
                        <div>
                            <h1 class="font-bold text-2xl text-red-500">
                                Mission
                            </h1>
                            <p class="font-roboto text-md pt-4">
                    ...
                    <div class="lg:flex lg:flex-row gap-8 m-8">
                        ...
                        />
                        <div>
                            <h1 class="font-bold text-2xl text-gray-950">
                                Goal
                            </h1>
                            <p class="font-roboto text-md pt-4">
                                {{ departmenthead.goal }}
                    ...
                    <!-- service -->
                    <div class="mt-4">
                        <h1 class="font-bold bg-gray-100 p-2 text-3xl">
                            our service
                        </h1>
                        <div v-for="service in services" :key="service.id">
                            <div
                                v-if="service.department == 'miniral'"
                                class="p-2 flex flex-row gap-3 hover:border-sky-100 hover:border-b w-full md:mt-0 hover:ml-4 mt-3 m-3 xl:p-0"
                            >
                                <i class="material-icons p-2 text-orange-300"
                                    >done</i
                                >
                                <p class="font-roboto text-md p-2">
                                    {{ service.service }}
                                </p>
                            </div>
                        </div>
