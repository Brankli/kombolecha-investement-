...
const submitForm = async () => {
  ...
  try {
    await axios.post("/api/store/sliders", formData);
  ...
  <div class="min-h-screen bg-gray-50 mb-24">
    ...
    <div class="max-w-3xl mx-auto px-4 py-8">
      <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 md:p-8">
        <div class="mb-8">
          <h2 class="text-2xl font-bold text-gray-800">Create New Slider</h2>
        ...
        <form @submit.prevent="submitForm" class="space-y-6">
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2"
              >Slider Title <span class="text-red-500">*</span></label
            >
            <input
              v-model="title"
              type="text"
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2"
              >Display Order <span class="text-red-500">*</span></label
            >
            <input
              v-model="order"
              type="number"
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2"
              >Slider Image <span class="text-red-500">*</span></label
            >
            <div class="relative">
              <input
                type="file"
              ...
              <div class="flex items-center gap-4">
                ...
                <span class="text-gray-500 text-sm" v-if="image">{{ image.name }}</span>
                <span class="text-gray-400 text-sm" v-else>No file chosen</span>
              </div>
            </div>
