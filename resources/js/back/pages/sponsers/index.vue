...
function getAllpartners(){
    axios.get('./api/getall/sponser').then(res => {
    ...
    <div class="bg-gray-100 mb-24">
        ...
        <div class="m-4 mt-12 rounded">
            <div class="w-full bg-white border-b-2 rounded border-gray-200 flex flex-row justify-between">
                <h1 class="font-bold text-gray-500 text-lg p-4 ">partner List</h1>
                                ...
                                <td class="px-6 py-4">
                                    <div class="w-fit flex flex-col md:mt-0 hover:ml-4 m-3 xl:p-0">
                                        <div class="flex gap-3 ">
                                            <img :src="sponser.image" class="w-16 h-10 object-cover" alt="work-image">
                                            <p class="hover:text-sky-800">{{ sponser.CompanyName }}</p>
                                        </div>
                                    </div>
                                </td>
                            </tr>
