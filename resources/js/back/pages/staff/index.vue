            ...
            <div class="flex bg-white flex-col items-center justify-center">
                <div class="w-full relative p-2 overflow-x-auto shadow-md sm:rounded-lg xs:p-5">
                    ...
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                        ...
                        <tbody>
                            <tr v-for="(staff, index) in paginatedData" :key="staff.id"
                                ...
                                <td class="px-6 py-4">
                                    <img :src="staff.image" class="w-16 h-10 object-cover" alt="staff-image" />
                                </td>

                                <td class="px-6 py-4">
                                    <button @click="deleteStaff(staff.id)" class="text-red-600 hover:underline">
                                        Delete
                                    </button>
                                </td>
                            </tr>
