...
const postwork = () => {
    ...
    axios
        .post("./api/store/PreviousWork", formData)
        .then((res) => {
        ...
        >
            <div class="w-full bg-white rounded-lg md:mt-0 xl:p-0">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    >
                        build your portifolio with previous work
                    </h1>
                    <form class="mb-6">
                        <div class="mb-6">
                            <label
                                ...
                                >Upload image of your work</label
                            >
                            <input
                                accept=".png,.jpg,.jpeg"
                                type="file"
                        ...
                        <div class="mb-6">
                            ...
                            >
                                <option
                                    value="In agro processing sectors"
                                    class="hover:bg-slate-500"
                                >
                                    In agro processing sectors
                                </option>
                                <option
                                    value="In chemical and construction sectors"
                                >
                                    In chemical and construction sectors
                                </option>
                                <option value="In the hotel and tourism sector">
                                    In the hotel and tourism sector
                                </option>
                                <option value="Construction sectors">
                                    Construction sectors
                                </option>
                                <option value="Urban agriculture sector">
                                    Urban agriculture sector
                                </option>
                                <option value="Social sectorr">
                                    Social sectorr
                                </option>
                            </select>
                        </div>
                        <button
                            @click.prevent="postwork"
                            class="text-white bg-blue-700 hover:bg-blue-800 w-fit mx-auto focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 block"
                        >
                            add works
                        </button>
                    </form>
