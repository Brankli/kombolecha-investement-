...
<template>
  <div>
    ...
    <div class="p-4 bg-gray-50 min-h-screen">
      ...
      >
        <h1 class="text-base font-semibold text-sky-700 mb-3">Post News</h1>

        <form @submit.prevent="post" class="space-y-4 text-sm">
          <!-- News Title -->
          <div>
            <label for="title" class="block mb-1 text-gray-700">News Title</label>
            <textarea
              id="title"
              :value="title"
          ...
          <!-- News Content Editor -->
          <div>
            <label class="block mb-1 text-gray-700">News Content</label>
            <div
              ref="editorContainer"
          ...
          <!-- Image Upload -->
          <div>
            <label for="file" class="block mb-1 text-gray-700">Upload Image</label>
            <input
              accept=".png,.jpg,.jpeg"
              type="file"
              ref="imageUpload"
