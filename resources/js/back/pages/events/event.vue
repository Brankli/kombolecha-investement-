...
const hidentrash = () => {
  ...
  axios
    .post("./api/event/hidden", { id: deletedevetId.value })
    .then((res) => {
            ...
            <div v-if="deletecountevent" class="align-middle">
              <p>
                <span
                  ...
                  >{{ deletecountevent }}</span
                >
                row selected
                <i
                  @click.prevent="hidentrash"
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500">
          <thead class="text-xs text-gray-700 uppercase bg-gray-50">
            <tr>
              ...
              <th scope="col" class="px-6 py-3">additional info</th>
              <th scope="col" class="px-6 py-3">News created_at</th>
            ...
            <tr class="bg-white border-b hover:bg-gray-50">
              <td @click.prevent="counthidentrash(event.id)" class="w-4 p-4">
                <div class="border-4 border-gray-200 text-center rounded w-5 h-5">
                  <p v-if="deletedevetId.includes(event.id)">
              ...
              <td class="preview quil-editor px-6 py-4" v-html="event.event"></td>
              <td class="px-6 py-4">
