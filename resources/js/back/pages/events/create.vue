        ...
        <div class="w-full bg-white rounded-lg md:mt-0 xl:p-0">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            <h1 class="text-lg text-sky-700 leading-tight tracking-wide">
              build your portifolio with privious work
            </h1>
            <form class="mb-6">
              <div class="mb-6">
              ...
              <div class="mb-6">
                ...
                <textarea
                  ...
                  rows="4"
                  class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 outline-none"
                  placeholder="# Please include any relevant links to additional information or related articles.."
                ></textarea>
              </div>
              <div class="mb-6">
                <label for="sector" class="block mb-2 text-sm font-medium text-gray-900"
                  >sector</label
                >
                <select
                  v-model="type"
